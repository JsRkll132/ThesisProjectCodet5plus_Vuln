...
gh_apikey = os.getenv('TOKEN_GITHUB_6')
...
async def process_commit_files(session, commit, previous_sha, keyword, prefix):
    ...
    asyncio.create_task(append_to_json_async(new_data, 'content_files_test7.json'))
...
async def main_():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        async with aiofiles.open('append_files_4_part1.json', 'r') as file:
